...
namespace Wesal.Persistence.Migrations
{
    ...
    [Migration("20260926122210_AddBookingDepositAndPaymentConfirmation")]
    partial class AddBookingDepositAndPaymentConfirmation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wesal.Domain.Entities.Booking", b =>
                {
                    ...
                    b.Property<Guid?>("ApprovalMessageId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("DepositPaymentConfirmedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("HallId", "Date", "Status");

                    b.ToTable("Bookings", "wesal");
                });

            modelBuilder.Entity("Wesal.Domain.Entities.BookingSlot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BookingId", "StartTime")
                        .IsUnique();

                    b.ToTable("BookingSlots", "wesal");
                });
            ...
            modelBuilder.Entity("Wesal.Domain.Entities.ConversationReadState", b =>
                {
                    ...
                    b.ToTable("ConversationReadStates", "wesal");
                });
            ...
            modelBuilder.Entity("Wesal.Domain.Entities.Hall", b =>
                {
                    ...
                    b.Property<TimeOnly?>("HourlySlotEnd")
                        .HasColumnType("time without time zone");

                    b.Property<TimeOnly?>("HourlySlotStart")
                        .HasColumnType("time without time zone");
                    ...
                    b.Property<bool>("ShowBookedSlots")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("Wesal.Domain.Entities.HallDayAvailability", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("HallId", "Date")
                        .IsUnique();

                    b.ToTable("HallDayAvailabilities", "wesal");
                });
            ...
            modelBuilder.Entity("Wesal.Domain.Entities.HallSlotAvailability", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("HallId", "Date", "StartTime")
                        .IsUnique();

                    b.ToTable("HallSlotAvailabilities", "wesal");
                });
            ...
            modelBuilder.Entity("Wesal.Domain.Entities.BookingSlot", b =>
                {
                    b.HasOne("Wesal.Domain.Entities.Booking", "Booking")
                        .WithMany("Slots")
