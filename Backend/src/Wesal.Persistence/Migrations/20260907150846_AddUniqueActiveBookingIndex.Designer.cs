...
namespace Wesal.Persistence.Migrations
{
    ...
    [Migration("20260907150846_AddUniqueActiveBookingIndex")]
    partial class AddUniqueActiveBookingIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wesal.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasIndex("ConversationId", "SenderUserId", "IdempotencyKey")
                        .IsUnique()
