...
/// created lazily for the hall's open window (<see cref="Hall.OpenTime"/> – <see cref="Hall.CloseTime"/>)
/// the first time a date is queried; a missing row means "available" for that hour.
/// </summary>
