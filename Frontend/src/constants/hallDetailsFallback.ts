...
export const DEMO_HALL_REVIEWS: HallReview[] = [
  {
    ...
    rating: 5,
    comment:
      "القاعة رائعة جداً والخدمة كانت متميزة. التنظيم كان فوق التوقعات والديكور فخم بكل تفاصيله.",
    timeAgo: "منذ يومين",
  },
  {
    id: "r2",
    ...
    rating: 5,
    comment:
      "تجربة ممتازة من أول التواصل حتى نهاية الحفل. الصوت والإضاءة احترافيين والمكان واسع ومريح للضيوف.",
    timeAgo: "منذ أسبوع",
  },
];
